    ...
    <Col className={"my-3"} xl={size} lg={size + 1} md={4} sm={6} xs={12}>
      ...
      >
        ...
        <Card.Body>
            ...
            return (
              <Card.Text key={i}>
                ...
                {e.type !== "checkbox" ? (
                  ...
                  <Icon.X style={{ color: "#e22b2b", fontSize: "24px" }} />
                ) : (
          ...
          <Button variant="primary" onClick={openItem}>
            {language[lang].showMore}
          </Button>
        </Card.Body>
        <Card.Footer>
          <Row>
            <Col xs={6} className={"px-0"}>
              <Card.Text style={{ fontSize: "13px" }}>
                {language[lang].likes}: {item.likes.length}
              </Card.Text>
            </Col>
            <Col className={"px-0"}>
              <Card.Text style={{ fontSize: "13px" }}>
                {language[lang].comments2}: {item.comments.length}
              </Card.Text>
            </Col>
          </Row>
        </Card.Footer>
