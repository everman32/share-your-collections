  ...
  return (
    <Navbar bg={theme} variant={theme} className={'w-100 bg-' + theme}>
      <Nav className='mr-auto'>
        ...
        {isLogged
          ? [
            <Nav.Link href={'/collections/' + String(userId)} key={0}>
              {language[lang].header.collections}
            </Nav.Link>,
            <Nav.Link href='/search/' key={1}>
              {language[lang].header.search}
            </Nav.Link>,
            role === 'Admin'
              ? (
                <Nav.Link href='/admin' key={1}>
                  {language[lang].header.manageusers}
                </Nav.Link>
                )
              : (
                  []
          ...
          : [
            <Nav.Link href='/search/' key={2}>
              {language[lang].header.search}
            </Nav.Link>,
            <Nav.Link className='d-sm-inline d-none' href='/signUp' key={0}>
              {language[lang].header.signup}
            </Nav.Link>,
            <Nav.Link href='/signIn' key={1}>
              {language[lang].header.signin}
            </Nav.Link>
            ]}
      </Nav>
...
function ThemeChange () {
  ...
  return (
    <Dropdown className='mr-md-4 mr-2'>
      ...
      <Dropdown.Menu>
        <Dropdown.Item onClick={setTheme}>
